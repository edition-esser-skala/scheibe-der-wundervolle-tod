\documentclass[shorttitlesize=50,tocstyle=ref-genre]{ees}

\shorttitle{Der wundervolle Tod}
...
\eesCriticalReport{
  –  & –   & A        & S 2 has been replaced by A throughout the work. \\
  ...
  16 & 76  & vla      & 2nd \halfNote\ in \A1: c′4–c′4 \\
}

\eesToc{
  {\ltseries\textmd{Soloists}\\[1ex]
  \textit{Canto I}\\
  Eidli\\
  Eine aus den Weibern\\[1ex]
  \textit{Canto II}\\
  Maria\\[1ex]
  \textit{Tenore}\\
